...
import com.example.erp.departmentservice.events.DepartmentCreatedPayload;
...
public class CreateDepartmentMapper
{
    ...
    public static DepartmentCreatedPayload mapEntityToEvent(Department entity)
    {
        return new DepartmentCreatedPayload(
                entity.getId(),
                entity.getName(),
