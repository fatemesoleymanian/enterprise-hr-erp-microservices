...
import com.example.erp.departmentservice.events.DepartmentUpdatedPayload;
...
public class UpdateDepartmentMapper
{
    ...
    public static DepartmentUpdatedPayload mapEntityToEvent(Department entity)
    {
        return new DepartmentUpdatedPayload(
                entity.getId(),
                entity.getName(),
